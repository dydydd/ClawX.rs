...
const UNIFIED_CHANNELS = new Set<string>([
  ...
  'app:name',
  'app:platform',
  // Settings commands now use direct IPC
  // 'settings:getAll',
  // 'settings:get',
  // 'settings:set',
  // 'settings:setMany',
  // 'settings:reset',
  // Provider commands now use direct IPC
  // 'provider:list',
  // 'provider:get',
  // 'provider:getDefault',
  // 'provider:hasApiKey',
  ...
  // 'provider:setDefault',
  // Update commands use direct Tauri commands now
  // 'update:status',
  // 'update:version',
  // 'update:check',
  // 'update:download',
  ...
  // Cron commands use direct Tauri commands now
  // 'cron:list',
  // 'cron:create',
  // 'cron:update',
  // 'cron:delete',
